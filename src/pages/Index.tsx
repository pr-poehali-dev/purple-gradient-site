        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="border-purple-100 hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Все донаты идут на оплату серверов, разработку новых режимов, проведение ивентов и призы для игроков. 
                  Мы прозрачны в использовании средств и регулярно отчитываемся перед сообществом.
                </p>
              </CardContent>
            </Card>
          </div>
